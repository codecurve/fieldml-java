    ...
    implements Evaluator
{
    ...
    public EvaluateSubtraction( Evaluator value1, Evaluator value2 )
    {
        this.value1 = value1;
        this.value2 = value2;
        this.constValue1 = 0;
    ...
    public EvaluateSubtraction( double constValue1, Evaluator value2 )
    {
        this.value1 = null;
        this.value2 = value2;
    ...
    public EvaluateSubtraction( Evaluator value1, double constValue2 )
    {
        this.value1 = value1;
        this.value2 = null;
        this.constValue1 = 0;
    ...
    public EvaluateSubtraction( double constValue1, double constValue2 )
    {
        this.value1 = null;
        this.value2 = null;
        this.constValue1 = constValue1;
